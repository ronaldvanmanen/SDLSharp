...
namespace SDL2Sharp.Video
{
    public readonly ref struct Nv12Image
    {
        ...
        private readonly ColorPlane _uvPlane;
        ...
        public unsafe Nv12Image(void* pixels, int height, int width, int pitch)
        {
            if (height < 0)
            {
            ...
            _uvPlane = new ColorPlane(pixels, height / 2, width, pitch / 2, width * pitch);
            _height = height;
            _width = width;
        }
