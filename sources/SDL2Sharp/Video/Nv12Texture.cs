...
{
    public sealed unsafe partial class Nv12Texture : IDisposable
    {
        ...
        // public void WithLock(WithLockNv12ImageCallback callback)
        // {
        //     WithLock(0, 0, Width, Height, callback);
        // }

        // public void WithLock(Rectangle rectangle, WithLockNv12ImageCallback callback)
        // {
        //     WithLock(rectangle.X, rectangle.Y, rectangle.Width, rectangle.Height, callback);
        // }

        // public void WithLock(int x, int y, int width, int height, WithLockNv12ImageCallback callback)
        // {
