...
{
    public sealed class AudioSubsystem : IAudioSubsystem, IDisposable
    {
        private const uint InitSubsystemFlags = SDL.SDL_INIT_AUDIO;

        public const int MixMaxVolume = SDL.SDL_MIX_MAXVOLUME;
